...
const (
	...
	DefaultDowntimeJailDuration = 60 * time.Second * 60 * 24 
)

var (
	DefaultMinSignedPerWindow      = sdk.NewDecWithPrec(5, 1)            //50%    600 * 0.5 = 300
	DefaultSlashFractionDoubleSign = sdk.NewDec(1).Quo(sdk.NewDec(20))   //  0.05
	DefaultSlashFractionDowntime   = sdk.NewDec(1).Quo(sdk.NewDec(1000)) //  0.001
)
