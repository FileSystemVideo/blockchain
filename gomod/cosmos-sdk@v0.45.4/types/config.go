...
const DefaultKeyringServiceName = "fsv"
...
func NewConfig() *Config {
	return &Config{
		...
		bech32AddressPrefix: map[string]string{
			...
			"eth_account_addr": Bech32PrefixEthAccAddr,
...
func (config *Config) GetBech32AccountEthAddrPrefix() string {
	return config.bech32AddressPrefix["eth_account_addr"]
}
