		...
		if validator != nil && !validator.IsJailed() {
			...
			ctx.EventManager().EmitEvent(
				sdk.NewEvent(
					...
					sdk.NewAttribute(types.AttributeKeyValAddress, validator.GetOperator().String()),         //
					sdk.NewAttribute(types.AttributeKeySlashFraction, k.SlashFractionDowntime(ctx).String()), //
				),
			)
