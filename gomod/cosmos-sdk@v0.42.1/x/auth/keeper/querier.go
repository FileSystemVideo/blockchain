...
func NewQuerier(k AccountKeeper, legacyQuerierCdc *codec.LegacyAmino) sdk.Querier {
	return func(ctx sdk.Context, path []string, req abci.RequestQuery) ([]byte, error) {
		...
		case types.QueryAccounts:
			return queryAccounts(ctx, k, legacyQuerierCdc)
...
func queryAccounts(ctx sdk.Context, k AccountKeeper, legacyQuerierCdc *codec.LegacyAmino) ([]byte, error) {
	...
	bz, err := codec.MarshalJSONIndent(legacyQuerierCdc, accountList)
	if err != nil {
...
func queryAccount(ctx sdk.Context, req abci.RequestQuery, k AccountKeeper, legacyQuerierCdc *codec.LegacyAmino) ([]byte, error) {
	...
	if account == nil {
		account = k.NewAccountWithAddress(ctx, addr)
