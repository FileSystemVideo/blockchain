...
import (
	...
	"encoding/json"
	"fmt"
	//upgradeTest "fs.video/blockchain/app/upgrades/test"
	"fs.video/blockchain/core"
	"fs.video/blockchain/x/copyright"
	"fs.video/blockchain/x/smart"
	"io"
	"net/http"
	"os"
	"path/filepath"
	...
	"fs.video/blockchain/app/ante"
	copyrightkeeper "fs.video/blockchain/x/copyright/keeper"
	copyrightTypes "fs.video/blockchain/x/copyright/types"
	smartKeeper "fs.video/blockchain/x/smart/keeper"
	smartTypes "fs.video/blockchain/x/smart/types"
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".data")

	// manually update the power reduction by replacing micro (u) -> atto (a) evmos
	sdk.DefaultPowerReduction = core.PowerReduction
}
...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		copyright.AppModuleBasic{},
		smart.AppModuleBasic{},
	)
	...
	maccPerms = map[string][]string{
		...
		core.KeyCopyrightBonus:    nil,
		core.KeyCopyrightMortgage: nil,
		core.KeyCopyrighDeflation: nil,
		copyrightTypes.ModuleName: nil,
		smartTypes.ModuleName:     nil,
	}
...
type Evmos struct {
	*baseapp.BaseApp
	...
	// Custom keepers
	CopyrightKeeper copyrightkeeper.Keeper

	SmartKeeper smartKeeper.Keeper
...
func NewEvmos(
	...
	govRouter.AddRoute(govtypes.RouterKey, govtypes.ProposalHandler).
		...
		AddRoute(smartTypes.RouterKey, smart.NewContractProposalHandler(&app.SmartKeeper))
	...
	// init copyright keeper
	app.CopyrightKeeper = *copyrightkeeper.NewKeeper(appCodec, keys[copyrightTypes.StoreKey], app.BankKeeper, app.StakingKeeper,
		app.DistrKeeper, app.SlashingKeeper, app.AccountKeeper, app.GetSubspace(copyrightTypes.ModuleName))

	// init smart keeper
	app.SmartKeeper = smartKeeper.NewKeeper(keys[smartTypes.StoreKey], appCodec, app.GetSubspace(smartTypes.ModuleName), app.AccountKeeper,
		app.BankKeeper, app.StakingKeeper, app.EvmKeeper)
	...
	app.mm = module.NewManager(
		...
		copyright.NewAppModule(appCodec, app.CopyrightKeeper),
		smart.NewAppModule(app.SmartKeeper, app.AccountKeeper),
	)
	...
	app.mm.SetOrderBeginBlockers(
		...
		copyrightTypes.ModuleName,
		smartTypes.ModuleName,
	)
...
func initParamsKeeper(
	...
	paramsKeeper.Subspace(smartTypes.ModuleName)
	paramsKeeper.Subspace(copyrightTypes.ModuleName)
	return paramsKeeper
}
