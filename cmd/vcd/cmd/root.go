...
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	initClientCtx := client.Context{}.
		...
		WithKeyringOptions(Option()).
		WithHomeDir(app.DefaultNodeHome).
		WithViper(EnvPrefix)

	rootCmd := &cobra.Command{
		Use:   app.Name,
		Short: "File System Video Chain",
...
func initAppConfig(chainID string) (string, interface{}) {
	...
	if strings.HasPrefix(chainID, "vc_8888-") && (srvCfg.MinGasPrices == "" || srvCfg.MinGasPrices == "0fsv") {
		srvCfg.MinGasPrices = "0.0025fsv"
	}
