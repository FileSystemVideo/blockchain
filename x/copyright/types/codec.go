...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	...
	cdc.RegisterConcrete(&MsgDeflationVote{}, MSG_TYPE_DEFLATION_VOTE, nil)
	cdc.RegisterConcrete(&MsgNftTransfer{}, MSG_TYPE_NFT_TRANSFER, nil)
	cdc.RegisterConcrete(&MsgInviteCode{}, MSG_TYPE_INVITE_CODE, nil)
	...
	cdc.RegisterConcrete(&MsgCopyrightBonus{}, MSG_TYPE_BONUS_COPYRIGHT, nil)
	...
	cdc.RegisterConcrete(&MsgAuthorizeAccount{}, MSG_TYPE_AUTHORIZE_NODE, nil)
	...
	cdc.RegisterConcrete(&MsgCopyrightBonusRear{}, MSG_TYPE_BONUS_COPYRIGHT_REAR, nil)
