...
type MessageResp struct {
	...
	NftTransfers    []NftTransferData    `json:"nft_transfers"`    //nft
	Delegations     []DelegationData     `json:"delegations"`      //dpos
	Undelegations   []UndelegationData   `json:"undelegations"`    //dpos
	//WithdrawDelegatorRewards []WithdrawDelegatorRewardData `json:"withdraw_delegator_rewards"` //dpos
	...
	//CopyrightVotes     []CopyrightVoteData     `json:"copyright_votes"`     
}
